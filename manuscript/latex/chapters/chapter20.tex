...
GR00T N1의 중요한 점은 humanoid foundation model을 단일 거대 policy로만 제시하지 않는다는 데 있다 \cite{grootn12025}. vision-language module과 diffusion transformer motor module의 분리는 Chapter 17의 hierarchy, Chapter 18의 real-time budget, Chapter 19의 safety envelope와 직접 연결된다.
