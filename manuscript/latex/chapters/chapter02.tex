...
\begin{enumerate}
  ...
  \item Chapter 4의 control interface와 Chapter 14의 action representation 논의를 위한 state notation을 준비한다.
\end{enumerate}
...
따라서 Chapter 14의 action representation 비교는 Chapter 2의 state/frame notation 위에 세워진다.
...
이 표는 Chapter 17의 evaluation protocol과 연결된다. Benchmark가 final success만 기록하면 estimation failure가 policy success 또는 policy failure로 잘못 분류될 수 있다.
